    ...
    <>
        <form className='w-2/6' onSubmit={submitSearchQuery}>
                ...
                <Suspense fallback={<div>Loading...</div>}>
                  <div className={`${searchResult.tracks && searchTerm? 'visible' : 'invisible'} absolute z-50 mt-2 w-[350px] h-[350px] overflow-y-scroll rounded-md dark:bg-gray-700 dark:text-white`}>
                      {
